...
class minhaClasse
{
    ...
    static void Main(string[] args)
    {
        ...
        for (int i = 0; i < t; i++)
        {
            ...
            cpa = Convert.ToDouble(valores[2], System.Globalization.CultureInfo.InvariantCulture);
            cpb = Convert.ToDouble(valores[3], System.Globalization.CultureInfo.InvariantCulture);
